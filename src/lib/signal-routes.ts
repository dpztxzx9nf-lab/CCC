...
/** Active operator movement between chambers — visual layer gates this separately. */
...
/** Comms-route geometry is attributed to continuity events (`deriveEventSignalRoutes`). */

export function collectActivePackets(
  occupantsByChamber: Partial<Record<ChamberId, ChamberOccupant[]>>,
  _operational: OperationalSnapshot | null,
  derivePacket: (
    operator: Operator,
