    ...
    projects: [
      {
        ...
        highlights: ["v0.1 stable shell", "Facility megastructure"],
        archivedAt: null,
        createdAt: now,
        updatedAt: now,
      },
      {
        ...
        description:
          "Central platform for systems, workflows, and outward projection — parent context for CCC.",
        status: "active",
      ...
      },
      {
        ...
        description:
          "Strategic AI guidance project aligned with ThinkCore continuity — architecture and projection.",
        status: "early",
